...
<form action="${pageContext.request.contextPath}/courseware/fileUpload.action" method="post" enctype="multipart/form-data"
      onsubmit="return check()">
    教学科目：<input id="subject" type="text" name="subject"/><br/>
    教案名称：<input id="name" type="text" name="name"/><br/>
    教案介绍：<input id="introduce" type="text" name="introduce"/><br/>
    请选择文件：<input id="file1" type="file" name="uploadfile" multiple="multiple"/><br/>
    <input type="submit" value="上传">

</form>


<%--<a href="${pageContext.request.contextPath}/courseware/download.action?filename=1_34a3bad8-d02d-4a97-8aa3-a2ac09f07e97_docker-compose.yml">文件下载</a>--%>
<!-- 搜索条件开始 -->
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="cartype" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="课件介绍" style="height: 30px;border-radius: 10px">
            </div>
        </div>
        <div class="layui-inline">
            <button type="button"
                ...
                <div class="layui-col-md9 layui-col-xs7">
                    ...
                    <div class="layui-form-item magt3">
                        ...
                        <div class="layui-input-block" style="padding: 5px">
                            ...
                            <input type="text" name="name" id="cname" autocomplete="off" class="layui-input"
                                   lay-verify="required"
                                   placeholder="请输入课件名称" style="height: 30px;border-radius: 10px">
                        </div>
                    </div>
...
<div id="viewCarImageDiv" style="display: none;text-align: center">
    <a alt="车辆图片" width="700px" height="450px" id="view_carimg" style="color: red">教案查看(点击下载)</a>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'upload'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${pageContext.request.contextPath}/courseware/getCourseware.action' //数据接口
            , title: ''//数据导出来的标题
            ...
            , cols: [[   //列表数据
                ...
                ,{title: '操作', width: 260, templet: '#carBar', fixed: "right", align: "center"}
            ]],
        ...
        function openUpdateCar(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${pageContext.request.contextPath}/courseware/editCourseware.action"
                }
            });
        }
