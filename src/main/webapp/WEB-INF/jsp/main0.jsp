    ...
    <div class="layui-header header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                <a href="javascript:;"><img src="${pageContext.request.contextPath}/images/timg.png" class="layui-nav-img">${currentUser.username}</a>
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${pageContext.request.contextPath}/user/userInfo.action" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                    </dd>
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${pageContext.request.contextPath}/user/editpsw.action" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                    </dd>
                    <dd>
        ...
        <div class="layui-tab" lay-filter="layuiminiTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div id="layuiminiHomeTabIframe" class="layui-tab-item layui-show">
                    <iframe width="100%" height="100%" frameborder="0" src="${pageContext.request.contextPath }/user/welcome.action"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script src="${pageContext.request.contextPath}/lib/layui-v2.5.4/layui.js?v=1.0.4" charset="utf-8"></script>
...
<script>
    layui.use(['element', 'layer', 'layuimini'], function () {
        var $ = layui.jquery,
            ...
            layer = layui.layer;
        layuimini.init('${pageContext.request.contextPath}/api/init0.json');

        $('.login-out').on("click", function () {
            layer.msg('退出登录成功', function () {
                window.location = '${pageContext.request.contextPath}/user/logout.action';
            });
        });
    });
</script>
