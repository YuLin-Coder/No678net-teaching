...
<form class="layui-form">
    ...
    <div id="toolbar" style="display: none"><h2>全部的学生信息</h2></div>
...
<script type="text/javascript">
    layui.use(['form','layer','table','laytpl','upload'],function(){
        ...
        var tableIns = table.render({
            elem: "#studentList",
            method:"POST",
            url : "${pageContext.request.contextPath}/studentCourse/stulistForM.action",
            request: {
                /* pageName: 'curr'
                 ,limitName: 'nums'*/
            },
            ...
            cols : [[
                ...
                {field: "score", title: "成绩", edit: "text", minWidth:60, align:"center"},
                {field: "result", title: "学习评价（差、一般、好、很好）", edit: "text", minWidth:250, align:"center"},
